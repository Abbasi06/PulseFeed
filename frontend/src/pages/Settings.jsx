...
export default function Settings() {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 sm:px-6 py-8">
      ...
      <p className="text-sm text-slate-400 mb-8">Update your profile to re-tune your feed.</p>
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3.5 py-2.5 bg-slate-800 border rounded-lg text-sm text-slate-200 placeholder-slate-500 outline-none transition-colors ${
              errors.name ? 'border-red-500' : 'border-slate-700 focus:border-violet-500 focus:ring-1 focus:ring-violet-500/30'
            }`}
          />
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3.5 py-2.5 bg-slate-800 border rounded-lg text-sm text-slate-200 placeholder-slate-500 outline-none transition-colors ${
              errors.occupation ? 'border-red-500' : 'border-slate-700 focus:border-violet-500 focus:ring-1 focus:ring-violet-500/30'
            }`}
          />
        ...
        {/* Interests */}
        <div>
          <label className="block text-sm font-medium text-slate-200 mb-1.5">Interests</label>
          <TagInput tags={interests} onChange={setInterests} placeholder="Add interest…" />
          {errors.interests && <p className="mt-1.5 text-xs text-red-400">{errors.interests}</p>}
        </div>

        {/* Hobbies */}
        <div>
          <label className="block text-sm font-medium text-slate-200 mb-1.5">Hobbies <span className="text-slate-500 font-normal">(optional)</span></label>
          <TagInput tags={hobbies} onChange={setHobbies} placeholder="Add hobby…" />
        </div>
