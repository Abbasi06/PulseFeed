    ...
    <div className="relative w-full min-h-screen bg-true-black text-off-white overflow-hidden font-sans">
      ...
      <nav className="relative z-40 flex items-center justify-between px-8 py-5 mt-1 liquid-glass mx-4 sm:mx-8 md:mx-16 rounded-2xl md:mx-auto max-w-7xl top-6">
        ...
        <div className="hidden md:flex gap-8 text-sm font-medium text-off-white/80">
            ...
            <a href="#engine" className="hover:text-white transition-colors">Antigravity Engine</a>
      ...
      <div className="relative z-30 flex flex-col items-center justify-center pt-40 px-4 text-center">
        ...
        >
            <motion.div variants={childVariants} className="mb-6 px-4 py-1.5 rounded-full liquid-glass text-sm font-medium text-mint-glow border border-mint-glow/30 flex items-center gap-2 shadow-[0_0_15px_rgba(209,232,226,0.2)]">
                <span className="w-2 h-2 rounded-full bg-mint-glow animate-pulse"></span>
                Zero-Gravity Data Lab
            </motion.div>

            <motion.h1 variants={childVariants} className="font-switzer text-6xl md:text-[5.5rem] font-black tracking-tighter leading-[1.05] mb-8">
                Evolve Your <br />
            ...
            <motion.p variants={childVariants} className="text-lg md:text-xl text-off-white/70 max-w-2xl mb-12 font-light">
                Experience the next generation of SaaS data synthesis. Frictionless processing meets stunning visual intelligence. 
            </motion.p>

            <motion.div variants={childVariants} className="flex flex-col sm:flex-row items-center gap-6">
      ...
      <div className="relative z-30 mt-[10vh] max-w-6xl mx-auto opacity-70" style={{ WebkitMaskImage: 'linear-gradient(to right, transparent, black 15%, black 85%, transparent)' }}>
        <p className="text-center text-sm text-off-white/50 mb-4 font-mono uppercase tracking-widest hidden md:block">Trusted by frontier teams</p>
        <InfiniteSlider />
      </div>
